...
from ZeniaMusic.utils.database import get_authuser_names, get_cmode
from ZeniaMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from ZeniaMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Zenia.stop_stream(message.chat.id)
    except:
        pass
