...
from ZeniaMusic.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from ZeniaMusic.utils.exceptions import AssistantErr
...
async def stream(
    ...
    if forceplay:
        await Zenia.force_stop_stream(chat_id)
