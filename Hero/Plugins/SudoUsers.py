...
@app.on_message(filters.command("vaddsudo") & filters.user(OWNER_ID))
...
@app.on_message(filters.command("vmaintenance") & filters.user(SUDOERS))
...
@app.on_message(filters.command("vgban") & filters.user(SUDOERS))
...
@app.on_message(filters.command("vungban") & filters.user(SUDOERS))
...
@app.on_message(filters.command("vbroadcast_pin") & filters.user(SUDOERS))
...
@app.on_message(filters.command("vbroadcast_pin_loud") & filters.user(SUDOERS))
...
@app.on_message(filters.command("vbroadcast") & filters.user(SUDOERS))
...
@app.on_message(filters.command("vclean") & filters.user(SUDOERS))
